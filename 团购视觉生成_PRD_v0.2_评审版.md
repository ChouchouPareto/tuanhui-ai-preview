...
| 待确认 | 一期是否直连平台并自动上传 | V0.2默认只导出，不自动发布 |
...
1. 每日从已获授权、允许自动访问或企业自有来源中抽取3—5个新增商户案例；遵守站点服务条款、robots规则、访问频控及知识产权要求。
...
2. **MVP发布边界**：仅生成和下载，还是必须在第一期直接提交抖音来客/美团生意宝？
3. **趋势采集边界**：首批允许采集的网站/账号、授权方式、是否仅保存设计特征，以及人工审核负责人是谁？
