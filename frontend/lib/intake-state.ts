export type DraftInput = { outputType?: string; deliveryTypes?: string[]; text: string; assetIds: string[]; style: string; provider: string; pending?: boolean; replyField?: string | null; useAi?: boolean; chat?: boolean };
