# PE工程快照：after-prompt-radical-simplify

UTC：20260919T162009.704105Z
...
SHA256：c4be9be3515b9cf82ab4c501dc62ce6cfd456ed4a27b296279727e1f0c691b61
...
def build_visual_prompt(plan: dict) -> str:
    if plan.get("template_version") == "region-master-v3":
        ...
        copy_x = next(r["box"][0] for r in plan["layout"]["regions"] if r["role"] == "copy")
        empty_side = "左" if copy_x < 0.5 else "右"
        subject_side = "右" if empty_side == "左" else "左"
        ...
        return f"{ratio}横向餐饮主题插画，主体是{subject}，{style}；主体放在画面{subject_side}侧，{empty_side}侧留出干净空间；{no_text}。"
    if plan.get("render_mode") == "illustration":
...
SHA256：d68f49771f0bcb6c199d14a11d9042b6da23a39c1ea307f74ff2f76896abcae5
