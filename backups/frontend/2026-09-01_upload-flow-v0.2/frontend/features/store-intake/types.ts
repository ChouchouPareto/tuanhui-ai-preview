...
export type Asset = { id: string; semantic_role: string; priority: number; is_hero: boolean; original_name: string; preview_path?: string; width?: number | null; height?: number | null };
